...
struct surface {
    ...
    int isHdrBinaryPair; //  Flag to indicate if grd file is GMT grd2xyz -ZTLd binary with matching ASCII GMT grdinfo header file <grd_file>.hdr  // 20170911 AJL - added to support compact binary surface files
    ...
    double dengrad; /* density gradient in layer */
    int plot; /* line plot style */
    int is_latlon; // 20161102 AJL - added to support x/y/elev grids as well as lat/lon/elev
};
